...
configtxgen -profile SampleSingleMSPEtcd -outputBlock ./channel-artifacts/${CHANNEL_NAME}.pb -channelID ${CHANNEL_NAME}
...
osnadmin channel join \
  ...
  --config-block ./channel-artifacts/${CHANNEL_NAME}.pb \
